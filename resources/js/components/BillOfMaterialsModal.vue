            ...
            <div class="mt-4">
                ...
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                  ...
                  <div class="grid grid-cols-2 sm:grid-cols-3 gap-px bg-gray-100">
                    <div class="bg-white px-4 py-3">
                      ...
                      <p class="mt-0.5 text-sm font-medium text-gray-800">{{ item?.DLACT == 1 ? 'Sì' : 'No' }}</p>
                    </div>
                    <div class="bg-white px-4 py-3">
              ...
              <div v-show="activeTab === 'immagini'" class="space-y-4">
                ...
                <div v-if="selectedFiles.length > 0" class="mt-4">
                  ...
                  <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    <div v-for="(fileItem, index) in selectedFiles" :key="index" class="relative group">
                      <img :src="fileItem.preview" :alt="fileItem.name" class="w-full h-24 object-cover rounded" />
                      <button
                      ...
                      <p class="text-xs text-gray-600 mt-1 truncate">{{ fileItem.name }}</p>
                    </div>
                  </div>
                  <button
                    @click="uploadImages"
              ...
              <div v-show="activeTab === 'pdf'" class="space-y-4">
                ...
                <div v-else-if="pdfUrl" class="w-full">
                  <div class="bg-gray-100 rounded-lg p-4">
                    <div class="flex items-center justify-between mb-3">
                      <h4 class="text-sm font-medium text-gray-900">{{ item?.DBART }}.pdf</h4>
                ...
                <div v-else class="text-center py-8">
                  ...
                  <p class="mt-1 text-xs text-gray-400">Cerca: {{ item?.DBART }}.pdf</p>
                </div>
              </div>
...
const fetchImages = async () => {
  const jobCode = props.item?.DLLAV
